        ...
        <div className="left">
          ...
          <div className="kontakty">
            ...
            <p style={{ marginTop: "2px" }}>
              Email:  <a href="mailto:email@jzitnik.dev">email@jzitnik.dev</a>
            </p>
            <p>
              Github: <a target="_blank" href="/link/github">JZITNIK-github</a>
            </p>
            <p>Instagram: <a target="_blank" href="/link/instagram">jakub_zitnik</a></p>
          </div>

          <p className="copyright">
            © Copyright <strong>Jakub Žitník</strong>.{" "}
            {texty["pravavyhrazena"]}.
          </p>
        </div>
        <div className="right">
