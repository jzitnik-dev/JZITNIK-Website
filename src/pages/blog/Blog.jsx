              ...
              {posts.map((e) => {
                return (
                  <Link key={e[0]} to={"/blog/" + e[0]}>
                    <div
                      className="prispevek animation"
                      style={{
                        transition: "ease 0.5s " + (0.2 + 0.2 / e[0]) + "s opacity, ease 0.5s " + (0.2 + 0.2 / e[0]) + "s top, ease 0.4s box-shadow",
                      }}
                    >
    ...
    <>
      ...
      <main className="content blogmain" style={{ display: "none" }}>
        <div className="monkey">
          <div className="element">{postsjsx}</div>
        </div>
      </main>
    </>
  );
