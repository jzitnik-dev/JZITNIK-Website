...
var sendMail = () => {
  document.querySelector(".contactElement .messages .load").style.display =
    "flex";
  setTimeout(() => {
          ...
          <div className="element animation">
            ...
            <ul className="skillsGrid animation">
              ...
              <li>
                ...
                <div className="slider">
                  <div className="slide nextjs"></div>
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="percentage">90%</div>
                <div className="slider">
                  <div className="slide nodejs"></div>
                </div>
              </li>
              <li>
